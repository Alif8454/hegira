...
import { CheckoutInfo, PageName } from '../../HegraApp';
...
const PaymentLoadingPage: React.FC<PaymentLoadingPageProps> = ({ 
  ...
  const handleCancelPayment = () => {
    // HegraApp's modal will use a generic message, or we can customize it
    // The title and message in HegraApp's ConfirmationModal should be updated for this case.
    // HegraApp's confirmation modal has been updated to handle this specific case message.
