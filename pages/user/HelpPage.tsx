...
const faqs = [
  ...
  { 
    question: "Bagaimana cara mendaftarkan atau mengelola event saya di Hegra?", 
    answer: "Jika Anda adalah seorang penyelenggara event dan tertarik untuk mempublikasikan serta mengelola event Anda melalui Hegra, silakan hubungi tim kami melalui halaman 'Kontak' atau kirimkan email ke partnership@hegra.com. Kami akan dengan senang hati membantu Anda." 
  },
  { 
    question: "Apa yang dimaksud dengan fitur Business Matching?", 
    answer: "Fitur Business Matching di Hegra bertujuan untuk mempertemukan Anda dengan individu atau perusahaan lain yang memiliki kesamaan minat atau kebutuhan bisnis. Ini bisa berupa pencarian vendor, supplier, investor, atau calon partner strategis untuk mengembangkan bisnis Anda." 
  },
  { 
    question: "Apakah data pribadi saya aman di platform Hegra?", 
    answer: "Keamanan dan privasi data Anda adalah prioritas utama kami. Hegra menerapkan standar keamanan yang tinggi dan mematuhi regulasi privasi data yang berlaku. Untuk informasi lebih detail, silakan tinjau 'Kebijakan Privasi' kami." 
  },
  {
    question: "Bagaimana jika saya mengalami masalah atau memiliki pertanyaan lain?",
    answer: "Tim support kami siap membantu Anda. Jangan ragu untuk menghubungi kami melalui email di support@hegra.com atau melalui formulir kontak yang tersedia di halaman 'Pusat Bantuan' ini. Kami akan merespons pertanyaan Anda sesegera mungkin."
  }
];
    ...
    <div className="bg-gray-50 min-h-full">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16">
        <header className="text-center mb-10 md:mb-16">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-hegra-navy">Pusat Bantuan Hegra</h1>
          <p className="mt-3 text-lg text-gray-600 max-w-2xl mx-auto">
            Temukan jawaban atas pertanyaan Anda mengenai platform Hegra.
          </p>
        </header>
